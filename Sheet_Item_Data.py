...
def Category_data(df):
    ...
    Category_data = [list(department_id),               ## department_id
                     ...
                     ['#FFFFFF'] * len(unique_Category_En), ## font_color
                     ['#1FA3DC'] * len(unique_Category_En), ## bg_color
...
def MenuItems_data(df):
    ...
    item_type_copy = df['Item_Type'].copy()
    item_type = item_type_copy.fillna(1)
    ...
    MenuItems_data = [df['Item_En'],               ## name
                     ...
                     ['#cae2fa'] * len(df['Item_En']), ## bg_color
